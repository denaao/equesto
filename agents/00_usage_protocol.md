...
| `start a project` / `frame this idea` | PROJECT_FOUNDATION | Interactive Discovery & Project Foundation Agent | Foundation Gate |
| `cut this to MVP` | PROJECT_FOUNDATION | Interactive Discovery & Project Foundation Agent | Foundation Gate |
| `fill context gap` | CONTEXT_DISCOVERY | Interactive Discovery & Project Foundation Agent | Foundation Gate (light) |
...
`/tasks/feature`, `/tasks/bug`, `/tasks/security`, `/tasks/sql-review`, `/tasks/architecture-review`, `/tasks/production-readiness`, `/tasks/test-flow`, `/tasks/incident`, `/tasks/migration-review`, `/tasks/project-discovery`, `/tasks/project-foundation`, `/tasks/mvp-structuring`, `/tasks/context-discovery`
