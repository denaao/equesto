...
- Foundation discovery bundle from Interactive Discovery & Project Foundation Agent (`PROJECT_BRIEF.md`, `MVP_SCOPE.md`, `INITIAL_ROADMAP.md`, `MODULE_MAP.md`, `RISKS_AND_ASSUMPTIONS.md`, `OPEN_QUESTIONS.md`, `CONTEXT_REGISTRY.md`, `DISCOVERY_LOG.md`, `ORCHESTRATOR_HANDOFF.md`) — Documentation Engineer applies documentation standards (naming, structure, indexing, freshness) but does NOT modify the discovery content. Foundation Agent owns discovery content; Documentation Engineer owns its standardization and discoverability inside the broader doc system.
...
- Stale documentation is worse than no docu